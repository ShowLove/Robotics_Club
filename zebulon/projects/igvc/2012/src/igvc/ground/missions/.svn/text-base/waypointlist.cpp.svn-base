...
{
    mXmlConf.GetVar("Ground.WayPointList.LIDAR@MaxDistance", mMaxDistanceThresh);

    mXmlConf.GetVar("Ground.WayPointList.Controls@DistanceThresh", mDistanceThresh);
    mXmlConf.GetVar("Ground.WayPointList.Controls@ForceWeight", mForceWeight);
    mXmlConf.GetVar("Ground.WayPointList.Controls@SinkWeight", mSinkWeight);
