...
class LoveLaneObject2 : public VisionObject
{
public:
    LoveLaneObject2();
    ~LoveLaneObject2();
    ...
    bool GetVisionReturn(const IplImage * imgIn, Vision::Return& horizontal, IplImage * debugOut) const;
protected:
    ...
    bool mSegment2EnabledFlag;
    double mSegment2Weight;
