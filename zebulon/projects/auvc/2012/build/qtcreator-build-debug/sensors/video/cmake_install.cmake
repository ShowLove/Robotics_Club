...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/zebulon/libcvcapture_d.so" AND
    ...
    FILE(RPATH_CHECK
         ...
         RPATH "")
  ENDIF()
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/zebulon" TYPE SHARED_LIBRARY FILES "/home/showlove/software/zebulon/projects/auvc/2012/lib/libcvcapture_d.so")
  IF(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/zebulon/libcvcapture_d.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/zebulon/libcvcapture_d.so")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/zebulon/libcvcapture_d.so")
...
IF(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  INCLUDE("/home/showlove/software/zebulon/projects/auvc/2012/build/qtcreator-build-debug/sensors/cmake.cvcapture.dvgrab/cmake_install.cmake")
  INCLUDE("/home/showlove/software/zebulon/projects/auvc/2012/build/qtcreator-build-debug/sensors/cmake.cvcapture.fw1394/cmake_install.cmake")
  INCLUDE("/home/showlove/software/zebulon/projects/auvc/2012/build/qtcreator-build-debug/sensors/cmake.cvcapture.libv4l/cmake_install.cmake")
