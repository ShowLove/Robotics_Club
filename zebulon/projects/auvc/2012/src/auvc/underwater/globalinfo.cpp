...
const std::string GlobalInfo::FixedYaw = "FixedYaw";
const std::string GlobalInfo::PathYaw = "PathYaw";
const std::string GlobalInfo::LastFixedYaw = "LastFixedYaw";
const std::string GlobalInfo::PingerDriveTime = "PingerDriveTime";
...
GlobalInfo::GlobalInfo()
{
    ...
    mCameraCallback = new VideoCallback(this);
}
...
//    }
    ...
    xmlConfig.GetVar("CameraReSize@resize", mReSizeFlag);
    xmlConfig.GetVar("CameraReSize@width", mReSizeWidth);
    xmlConfig.GetVar("CameraReSize@height", mReSizeHeight);
