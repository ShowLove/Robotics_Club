...
#ifndef __ZEBULON_UNDERWATER_VISION_COLOROBJECT_
#define __ZEBULON_UNDERWATER_VISION_COLOROBJECT_

using namespace Zebulon;
using namespace Vision;

class ColorObject : public VisionObject
{
public:
    ColorObject();
    ~ColorObject();
    ...
    bool GetVisionReturn(const IplImage * imgIn, std::vector<Vision::Return>& result, IplImage * debugOut, int uptocount=2) const;
protected:
